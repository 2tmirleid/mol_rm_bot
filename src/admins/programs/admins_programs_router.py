...
@router.callback_query(F.data == 'admins_edit_program_description')
async def process_admins_edit_program_description(clb_query: CallbackQuery, state: FSMContext):
    await admins_programs_controller.admins_edit_program_description(clb_query.message, state)


@router.message(StateFilter(
    EditProgramState.description
), F.text)
async def process_admins_edit_program_description_finish(msg: Message, state: FSMContext):
    await admins_programs_controller.admins_edit_program_description_finish(msg, state)
